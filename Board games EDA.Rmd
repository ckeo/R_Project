...
games_ptcleaned %>%
  ggplot(aes(x = factor(game_lengths, level = (level_order)))) + geom_bar(fill = wes_palette(n = 1, name = "FantasticFox1")) + coord_flip() + labs(title = "Board Game Lengths") + scale_x_discrete(name="Board Game Length") + scale_y_continuous(name="Count")
...
games_ptcleaned %>%
    ggplot(aes(x = factor(game_lengths, level = level_order), y = average)) + geom_boxplot(fill = c(wes_palette(n=5, name="FantasticFox1"), wes_palette(n = 1, name = "Zissou1"))) + labs(title = "Average User Scores by Game Length", ylab = "User Scores") + scale_x_discrete(name="Board Game Length")  + scale_y_continuous(name = "Average User Score") + coord_flip()
